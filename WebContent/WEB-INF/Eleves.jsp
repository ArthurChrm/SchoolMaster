...
<t:GenericLayout>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAjouterEleve" id="ajouterClasse">Ajouter un élève</button>
...
<div class="form-group">
    ...
    <div class="modal fade" id="modalModifierEleve" tabindex="-1"
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalModifierEleveLabel">Modification d'un élève</h5>
            <button type="button" class="close" data-dismiss="modal"
							aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
